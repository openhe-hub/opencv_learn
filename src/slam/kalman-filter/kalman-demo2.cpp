...
#define PRED_DURATION 5

// This program add prediction duration
// after the given dataset, we will give the prediction data

int main() {
    //generate data
    const int N = 20;
    const double k = 2.5;
    std::ofstream ofs(R"(../src/slam/kalman-filter/out/kalman2.txt)");
